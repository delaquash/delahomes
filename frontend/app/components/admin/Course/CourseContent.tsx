...
const CourseContent = ({
  ...
  return (
    <div className="w-[80%] m-auto mt-24 p-3">
        ...
        {Array.isArray(courseContentData) && courseContentData.map((item: any, index: number) => {
         ...
         `videoSection` value in the `courseContentData` array. */
          const showSectionInput =
            index === 0 ||
            item.videosSection !== courseContentData[index - 1].videoSection;
          return (
            <>
              <div
              ...
              >
                ...
                <div className="flex w-full items-center justify-between my-0">
                  ...
                  <div className="flex items-center">
                    <AiOutlineDelete
                      className={`dark:text-wrap text-[25px] mr-2 text-black ${
      ...
      <div className="w-full flex items-center justify-between">
        <div
          className=" w-[60px] 800px:w-[100px] justify-center flex items-center 
        ...
        <div
          className=" w-full 800px:w-[100px] flex justify-center items-center 
                h-[40px] bg-[#37a39a] text-center text-[#fff] rounded mt-4 cursor-pointer"
