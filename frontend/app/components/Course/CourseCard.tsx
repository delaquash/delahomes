...
const CourseCard = ({ course, isProfile}: Props) => {
  return (
    <Link href={!isProfile ? `/course/${course.id}` : `course-access/${course.id}`}>
      ...
      <Image src={course.thumbnail.url} alt="" width={500} height={300} objectFit="containt" className="rounded w-full"/>
        <br />
